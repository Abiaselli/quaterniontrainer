...
class QuaternionGeneticAlgorithm:
    ...
    def select_best(self, loss_fn, inputs, targets, mask):
        best_model = None
        best_loss = float('inf')
        n=0
    ...
    def evolve(self, loss_fn, inputs, targets, mask):
        best_model = self.select_best(loss_fn, inputs, targets, mask)
        ...
        return self.select_best(loss_fn, inputs, targets, mask)
            ...
            for epoch in range(self.epochs.get()):
                ...
                for batch_idx, (batch_input_ids, batch_labels, seq_lengths) in enumerate(dataloader):
                    ...
                    if self.use_genetic_algo == "Genetic Algorithm":
                        ...
                        self.model = qga.evolve(F.cross_entropy, batch_input_ids, targets_reshaped, combined_mask)
