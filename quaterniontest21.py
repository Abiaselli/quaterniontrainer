...
tokenizer_path = r"/home/austin/vccode/mhlatest-main"  
    ...
    def generate(self, prompt, max_new_tokens=50, seq_len=32, return_text=True):
        ...
        for _ in range(max_new_tokens):
            ...
            with torch.no_grad():
                ...
                next_token2 = torch.argmax(next_token_logits, dim=-1)
            ...
            generated_2.append(next_token2.item())
            ...
            if next_token == self.tokenizer_wrapper.eos_token:
                break
            tgt_ids = torch.cat([tgt, next_token2.unsqueeze(0)], dim=1)
            src = torch.cat([src, next_token2.unsqueeze(0)], dim=1)
        if return_text:
...
def main():
    ...
    parser.add_argument('--data', type=str, default=r"/home/austin/vccode/mathtest", help='Path to JSON data')
