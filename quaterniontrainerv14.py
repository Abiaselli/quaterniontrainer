    ...
    def select_best(self, loss_fn, data_loader):
        ...
        for model in self.population:
            ...
            for batch in data_loader:
                ...
                loss += loss_fn(output, batch[1]).item()
...
class QuaternionTransformerGUI:
    ...
    def training_loop(self):
        ...
        try:
            ...
            optimizer_q = QuaternionGHROptimizer(quaternion_params, lr=0.001)
            ...
            for epoch in range(self.epochs.get()):
                ...
                for batch_idx, (batch_input_ids, batch_labels, seq_lengths) in enumerate(dataloader):
                    ...
                    print(f"Iteration {n}, Loss: {loss.item()}, LR_std: {optimizer_std.param_groups[0]['lr']}, LR_q: {optimizer_q.param_groups[0]['lr']}")
